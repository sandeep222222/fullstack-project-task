      ...
      <div className="flex items-center justify-center p-12">
          <div className="mx-auto w-full max-w-[550px] bg-white">
              <form>
                  ...
                  <div className="mb-5">
                      <label for="qualification" className="mb-3 block text-base font-medium text-[#07074D]">
                          Qualification
                      </label>
                  ...
                  <div className="mb-5">
                      <label for="experience" className="mb-3 block text-base font-medium text-[#07074D]">
                          Experience
                      </label>
                  ...
                  <div className="mb-5">
                      <label for="skills" className="mb-3 block text-base font-medium text-[#07074D]">
                          Skills
                      </label>
                      <input type="text" name="skills" id="skills" placeholder="Enter your skills"
                          className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                  </div>
                  {/* https://tailwindflex.com/@jaxstone/survey-form */}
